 ...
 * tags:
 *   name: SubCategory
 *   description: Api endpoint to manage subategory
 */
 ...
 *                 message:
 *                   type: string
 *                   example: Sub Cateorgory details created successfully
 *       "400":
 *         description: Bad request
 *         content:
 *           application/json:
 ...
 * /subCategory/{catId}:
 *   get:
 *     summary: Get subategories by category
 *     tags:
 *       - SubCategory
 *     requestBody:
 *       required: true 
 ...
 * /subCategory/{catId}:
 *   patch:
 *     summary: upate subcategory details
 *     tags:
 *       - SubCategory
 *     parameters:
 *       - in: path
 ...
 *                 message:
 *                   type: string
 *                   example: dubcategory details updated successfully
 *       "400":
 *         description: Bad request
 *         content:
 *           application/json:
